...
active_learning_config = {
    "ensemble_size": 5,
    "acquisition": tune.grid_search([GreedyAcquisition]), #([GreedyAcquisition, UCB, RandomAcquisition]), #ProbabilityOfImprovementAcquisition, UCB, ExpectedImprovementAcquisition]), #([GreedyAcquisition, UCB, RandomAcquisition]),
    "patience_max": 4,
    "kappa": 1,
